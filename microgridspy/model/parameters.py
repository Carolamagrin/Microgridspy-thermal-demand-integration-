...
class ProjectSettings(BaseModel):
    ...
    direct_cop_mode: str = "fixed"
    direct_cop_fixed: Optional[float] = None
    direct_cop_alpha: float = 0.25
    direct_cold_temp_c: float = 7.0
...
class TESParams(BaseModel):
    tes_optimize_capacity: bool = False
    tes_capacity_max: Optional[float] = None
    tes_capacity: Optional[float] = None
    tes_initial_soc: float
    tes_max_charge_rate: float
    tes_max_discharge_rate: float
    tes_storage_efficiency: float
    tes_cop_mode: str = "fixed"          #fixed
    tes_cop_fixed: Optional[float] = None
    tes_cop_alpha: float = 0.25
    tes_cold_temp_c: float = -5.0
    tes_q_per_kg: float
    ...
    tes_compressor_capacity_max: float 
    tes_pump_specific_consumption: float = 0.02
    tes_charcoal_temp_reduction_c: float = 7.5
