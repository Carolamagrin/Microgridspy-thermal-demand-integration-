...
from microgridspy.gui.views.cooling_page import cooling_technology
...
def main() -> None:
    ...
    if st.sidebar.button("Cooling Technology", disabled=not buttons_enabled):
        if buttons_enabled:
    ...
    if st.session_state.page not in [
        "New Project", "Project Settings", "Advanced Settings",
        "Resource Assessment", "Demand Assessment", 
        "Cooling Technology",
        "Renewables Characterization", "Battery Characterization",
        "Generator Characterization", "Grid Connection",
        "Optimization", "Results", "Project Profitability"
]:
        st.session_state.page = "New Project"

    if not st.session_state.get("new_project_completed", False):
        st.session_state.page = "New Project"
    ...
    pages = {
        ...
        "Cooling Technology": cooling_technology,
